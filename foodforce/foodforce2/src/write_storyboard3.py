...
def write_data():
    ...
    output = open('storyboards/storyboard2/storyboard.pkl','wb')
    
    #Introduction data
    text = 'The city of Haiti has been seismicaly active from centuries.It has ,in the past, endured severe earthquakes some of which have collapsed the whole city.The Australian government travel advisory site had previously expressed concerns that Haitian emergency services would be unable to cope in the event of a major disaster, and the country is considered economically vulnerable by the Food and Agriculture Organisation.This time it has been struck by an earthquake which has destroyed most of the buildings and severly deteriorated the condition of the city.Various teams has been sent by different countries to take care of the situation and help in any way they can.You being the head of the city have to work in collaboration with all the teams sent for your aid and ensure that the peace of the city is restored.The different teams sent to for your help will keep you updated on the current condition of improvement.'
    action = [7,text]
    ...
    chatText = ['Stevenson Gorbachev','The earthquake has destroyed everything.',
                'Tony Peralta','At this point of time it is necessary that the survivors be located or people who cant be accessed due to blocking of all kinds of transportation be supplied with food and medicines.',
                ...
                'Tony Peralta','The city also need more hospitals , as only two fully functional hospitals are left in the city and they are overcrowded.There are hundreds of injured people.It is estimated that as many as 20,000 people will die each day that could have been saved by surgery']
